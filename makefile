...
revision:
	@PYTHONPATH="${PYTHONPATH}" python3 ./src/database/migration/revision.py

upgrade:
	@PYTHONPATH="${PYTHONPATH}" python3 ./src/database/migration/upgrade.py

downgrade:
	@PYTHONPATH="${PYTHONPATH}" python3 ./src/database/migration/downgrade.py $1
